 ...
 *  time to run version 1. Version 2 will use one or
 *  two distance sensors to move off of the alliance
 *  wall and then move toward the audience wall.
 *
 *  Robot will start in the rightside position on the Blue
 ...
 */
@Autonomous(name = "NelsonBot: Auto Blue Side Carousel by Time 01", group = "NelsonBot")
//@Disabled

public class AutoBasicBluCarouselStorage extends LinearOpMode {
...
//        currentDist = myMec.getCurrentDistance(DistanceUnit.INCH);
//        while(currentDist > 4.5){
//            myMec.setSlideRight(FORWARD_SPEED);
//            currentDist = myMec.getCurrentDistance(DistanceUnit.INCH);
//            telemetry.addData("Distance (IN)", myMec.getCurrentDistance(DistanceUnit.INCH));
//            telemetry.update();
//        }
